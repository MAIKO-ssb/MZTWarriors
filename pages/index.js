  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="We are the Manzanita Tribe Warriors ᴹᶻᵀ, a local esports team based out of Southern California. We play competitive Super Smash Bros. Ultimate" />
            ...
            <div style={{maxWidth:"650px"}}>
              { 
                ...
                <>
                  ...
                  <p>
                    We are the Manzanita Tribe Warriors ᴹᶻᵀʷ, a local esports team based out of Southern California. 
                  </p>
                  <p> 
                  ...
                  <button>
                    <a href="https://discordapp.com/channels/596954512661413890/934588025294438400" rel="noreferrer" target="_blank" icon="discord">
                      <span style={{fontSize: ".85em"}}>Mint 🔜 Join</span> 
                      <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="discord" className="svg-inline--fa fa-discord fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                  ...
                  <div>
                    ...
                    &nbsp;
                    <small style={{display: 'inline'}}>(Whitelist: .1 sol)</small>
                  </div>
                  <br/>
                  <small>
